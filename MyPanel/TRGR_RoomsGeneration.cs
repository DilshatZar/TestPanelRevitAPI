...
namespace MyPanel
{
    ...
    public class TRGR_RoomsGeneration : IExternalCommand
    {
        ...
        ConfigSettingsWindow config;

        AnswerWindow ans = new AnswerWindow("Помещения");//delete
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            config = new ConfigSettingsWindow();
            ...
            try
            {
                ...
                roomUp = int.Parse(config.GetParameterValue("RoomUpperOffset"));
                roomDown = int.Parse(config.GetParameterValue("RoomLowerOffset"));
            }
            catch (Exception ex)
            {
